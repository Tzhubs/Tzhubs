...
if support[exploit()]  then
 ...
 game.Players.LocalPlayer:Kick("Ko Hỗ Trợ Executor | Not Support Executor | Tidak Mendukung Pelaksana | support fluxus,hydrogen,delta,alysse,trigon,vegaX")
 end
...
local Tabs = {
    ...
    Teleport = Window:AddTab({ Title = "Teleport", Icon = "rbxassetid://113806187616600" }),
    Fruit = Window:AddTab({ Title = "Fruit", Icon = "rbxassetid://113806187616600" }),
...
OrionLib:MakeNotification(
        {
            ...
            Image = "rbxassetid://113806187616600",
            Time = 7
        }
    )
_G.lakala = true

setclipboard("MutanoX-HUB Is The Best")
	...
	if (getgenv().ED_AntiKick.CheckCaller and not checkcaller() or true) and stringlower(getnamecallmethod()) == "kick" and ED_AntiKick.Enabled then
		if getgenv().ED_AntiKick.SendNotifications then
			StarterGui:SetCore("SendNotification", {
				...
				Icon = "rbxassetid://113806187616600",
				Duration = 2,
			})
		end
...
ImageButton.Image = "http://www.roblox.com/asset/?id=109212603905955"
...
Tabs.Main:AddButton({
        Title = "MutanoX-HUB Discord Server",
...
Fluent:Notify({
    Title = "MutanoX-HUB",
    Content = "Thanks For Using MutanoX-HUB",
    Duration = 8
})
