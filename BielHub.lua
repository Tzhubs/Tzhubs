...
local Window = OrionLib:MakeWindow({Name = "Meu Script", HidePremium = false, SaveConfig = true, ConfigFolder = "OrionTest"})
...
-- Adicione funções para SubFarming aqui
-- Exemplo:
-- SubFarmingTab:AddButton({
--     Name = "Iniciar SubFarming",
--     Callback = function()
--         print("SubFarming iniciado!")
--         -- Código da função de subfarming
--     end    
-- })
...
-- Adicione funções para Stats aqui
...
-- Adicione funções para Frutas aqui
...
-- Adicione funções para Raids aqui
...
-- Adicione funções para ESP aqui
...
-- Adicione funções para Configurações aqui
...
-- Adicione funções para Webhook Teleport aqui
